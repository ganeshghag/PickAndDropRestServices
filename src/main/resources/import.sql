...
insert into pickup_locations(name,address_line1,address_line2,address_line3,address_line4,pincode) values ('Viviana Mall','Eastern Express Highway','Near Jupiter Hospital','Thane','Thane','400601')
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK92839','24 x 50 x 50 cm',10,72772373772,'202 Flower Valley','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400601','Netbanking',1)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK92849','24 x 50 x 50 cm',10,72772373772,'203 Flower Valley','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400602','COD',1)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK92859','24 x 50 x 50 cm',10,72772373772,'204 Flower Valley','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400603','Netbanking',1)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK92869','24 x 50 x 50 cm',10,72772373772,'205 Flower Valley','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400604','COD',1)

insert into pickup_locations(name,address_line1,address_line2,address_line3,address_line4,pincode) values ('R City Mall','Ghatkopar','Ghatkopar','Mumbai','Mumbai','483737')
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK93839','24 x 50 x 50 cm',10,72772373772,'920 Runwal Nagar I','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400601','Netbanking',2)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK94839','24 x 50 x 50 cm',10,72772373772,'921 Runwal Nagar II','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400602','COD',2)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK95839','24 x 50 x 50 cm',10,72772373772,'922 Runwal Nagar I','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400603','Netbanking',2)
insert into parcel(package_id,dimensions,weight,scheduled_date_time,address_line1,address_line2,address_line3,address_line4,pincode,payment_type, pickup_locations_locationId) values('PCK96839','24 x 50 x 50 cm',10,72772373772,'923 Runwal Nagar II','Eastern Express Highway','Opp. Jupiter Hospital','Thane','400604','COD',2)
...
-- Thane
insert into city(country, name, state, map) values ('India', 'Thane', '', '38.895112, -77.036366')
insert into hotel(city_id, name, address, zip) values (22, 'Hotel Atithi', 'Pokhran Road 2', '400601')
